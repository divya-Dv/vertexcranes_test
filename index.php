...
<section id="service" class="services-mf route">
  ...
  <section id="blog" class="blog-mf sect-pt4 route">
    <div class="container-fliud sr-main">
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            <h3 class="title-a slideInRight">
             Our Products
            </h3>
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><a href="leg-gantry-crane.php">Leg Gantry</a></h6>
                </div>
              </div>
              
              <p class="card-description">
               VERTEX make Deck - Leg Gantry which is most commonly used type.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><a href="electric-winch.php">Electric Winch</a></h6>
                </div>
              </div>
       
              <p class="card-description">
                VERTEX make Rope Drum type Electric Winches are designed to pull or lift loads.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
            <h6 class="category"><a href="jib-cranes.php">Jib Cranes</a></h6>
                </div>
              </div>
      
              <p class="card-description">
               We are the most popular manufacturers and exporters of Jib Cranes in India.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><a href="portal-gantry.php">Portal Gantry</a></h6>
                </div>
              </div>
      
              <p class="card-description">
             Portal Gantry are the gantry that is used to carry loads in the front section of the crane.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><a href="double-girder-eot-cranes.php">Double Girder EOT Cranes</a></h6>
                </div>
              </div>
      
              <p class="card-description">
             VERTEX manufacture Double Girder EOT Cranes which provides space.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              <div class="card-category-box">
                <div class="card-category">
                  <h6 class="category"><a href="gantry-crane.php">Gantry Crane</a></h6>
                </div>
              </div>
      
              <p class="card-description">
             We are the pre-eminent manufacturers and exporters of versatile Gantry Cranes.
              </p>
            </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-01.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/gallery-01-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/gallery-01-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/gallery-01-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/gallery-01-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/gallery-01-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-02.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/gallery-02-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/gallery-02-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/gallery-02-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/gallery-02-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/gallery-02-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-15.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/gallery-15-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/gallery-15-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/gallery-15-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/gallery-15-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/gallery-15-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-04.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/gallery-04-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/gallery-04-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/gallery-04-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/gallery-04-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/gallery-04-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-05.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/e11-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/e11-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/e11-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/e11-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/e11-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/gallery-06.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/gallery-06-1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/gallery-06-1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/gallery-06-1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/gallery-06-1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/gallery-06-1.webp" alt="Jib Crane Manufacturers" class="img-fluid" loading="lazy" decoding="async"></picture>
              </div>
...
<div class="row">
<div class="col-sm-12">
<div id="demo-video-custom" class="carousel slide  new-01" data-ride="carousel">
...
<div class="work-box">
            <a href="img/award-inner-two.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/award-two_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/award-two_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/award-two_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/award-two_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/award-two.webp" alt="Jib Crane Manufacturers" class="img-fluid" style="height:350px;width:100%" loading="lazy" decoding="async"></picture>
              </div>
...
<div class="work-box">
            <a href="img/award-inner-four.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/award-four_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/award-four_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/award-four_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/award-four_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/award-four.webp" alt="Jib Crane Manufacturers" class="img-fluid" style="height:350px;width:100%" loading="lazy" decoding="async"></picture>
              </div>
...
<div class="work-box">
            <a href="img/award-inner-five.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/award-five_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/award-five_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/award-five_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/award-five_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/award-five.webp" alt="Jib Crane Manufacturers" class="img-fluid" style="height:350px;width:100%" loading="lazy" decoding="async"></picture>
              </div>
...
<div class="work-box">
            <a href="img/award-inner-six.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/award-six_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/award-six_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/award-six_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/award-six_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/award-six.webp" alt="Jib Crane Manufacturers" class="img-fluid" style="height:350px;width:100%" loading="lazy" decoding="async"></picture>
              </div>
...
<div class="work-box">
            <a href="img/award-inner-seven.webp" data-lightbox="gallery-mf">
              <div class="work-img">
                <picture><source srcset="img/320w/award-seven_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/award-seven_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/award-seven_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/award-seven_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="img/award-seven.webp" alt="Jib Crane Manufacturers" class="img-fluid" style="height:350px;width:100%" loading="lazy" decoding="async"></picture>
              </div>
  ...
  <a class="carousel-control-prev" href="#demo-video-custom" data-slide="prev">
    <span class="carousel-control-prev-icon"></span>
  </a>
  <a class="carousel-control-next" href="#demo-video-custom" data-slide="next">
    <span class="carousel-control-next-icon"></span>
  </a>
</div>
...
<div class="row">
<div class="col-sm-12">
<div id="demo-video" class="carousel slide  new-01" data-ride="carousel">
...
<!--<div class="col-md-6 col-lg-6">
<div class="vir-01">
<iframe width="100%" height="400" src="https://www.youtube.com/embed/Vsg16sjdtn0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<h4>Different Manufacturing Plant & Steel Mill Cranes Working</h4>
</div>
</div>-->
...
<!--  Your browser does not support the video tag.-->
<!--</video>-->
<!--<h4>Mechanical Workshop Gorakhpur - North Eastern Railway</h4>-->
<!--</div>-->
<!--</div>-->
<div class="col-md-6 col-lg-6">
<div class="vir-01">
...
<h4>Mechanical Workshop Bhusawal - Central Railway</h4>
</div>
</div>
...
<h4> Mechanical Workshop Gorakhpur - North Eastern Railway</h4>
        ...
        <!--          Your browser does not support the video tag.-->
        <!--        </video>-->
        <!--        <h4><b>Load Test: </b> Electric Locomotive Workshop Bhusawal - Central Railway</h4>-->
        <!--        </div>-->
        <!--        </div>-->
        <div class="col-md-6 col-lg-6">
            <div class="vir-01">
...
<h4>South Central Railway Guntupally</h4>
</div>
</div>
...
<h4>South Central Railway Tirichi</h4>
</div>
</div>
<!---->
<div class="col-md-6 col-lg-6">
...
<h4>South Central Railway Perambur</h4>
</div>
</div>
  ...
  <div class="container-fluid">
  <div class="row">
 <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7601.168440121814!2d78.467093!3d17.717091!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe0d0ecc3e0436008!2sVERTEX%20CRANES%20%26%20HOISTS!5e0!3m2!1sen!2sin!4v1574853070015!5m2!1sen!2sin" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
