...
<div id="home" class="intro route pro-bg">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h1 class="intro-title mb-4">Gantry Cranes</h1>
...
<ul class"seo_li"="">
            ...
            <li><a href="https://www.vertexcranes.com/eot-cranes/single-girder-eot-crane-manufacturers.php">Single Girder EOT Crane Manufacturers</a></li>
...
<div class="row">
<div class="col-md-6">
<h3 class="att-01">Attributes of our Gantry Cranes:</h3>
<div class="list-01">
