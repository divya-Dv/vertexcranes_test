...
$to = "vertexcranes@gmail.com, info@vertexcranes.com";
...
// 		CURLOPT_POST =&gt; true,
// 		CURLOPT_POSTFIELDS =&gt; [
// 			'secret' =&gt; '6Lf0qCErAAAAAHScm6YqpLzfenMdXG0JtLIYVGYh',
// 			'response' =&gt; $_POST["token"],
...
// Additional headers
$fromName = "Vertex Cranes"; // You can customize the name
$headers .= 'From: ' . $fromName . ' <info@vertexcranes.com>' . "\r\n";
// $headers .= 'From: <noreply@karolipipes.com>' . "\r\n";
$headers .= 'Bcc: mahima@grank.co.in, durga@grank.co.in, seo.grank@gmail.com' . "\r\n";
// $headers .= 'Bcc: mahima@grank.co.in' . "\r\n";

// Send the email
if(mail($to, $subject, $message, $headers)) {
    // Redirect to thank you page after email is sent successfully
    header("Location: thankyou.php");
    exit;
} else {
    // Redirect to error page if email fails to send
    echo "Email Not Sent!!. Please try again";
    exit;
}

// 	$mail = new PHPMailer();		
//     	$mail-&gt;From      = 'noreply@karolipipes.com';		
//     	$mail-&gt;FromName  = "TD-G Rank-Enquiry";		
//     	$mail-&gt;Subject   = $subject;		
//     	$mail-&gt;Body      = $message;		
//     	$mail-&gt;SetFrom( "noreply@karolipipes.com", 'Karoli Pipes');
    
       
//         $mail-&gt;AddAddress('karolipipes@gmail.com', 'Karoli Pipes');
//          $mail-&gt;AddBCC('durga@grank.co.in', 'G Rank ');
       
//           $mail-&gt;AddBCC('seo.grank@gmail.com', 'G Rank');
//              $mail-&gt;AddBCC('kalyanrao@grank.co.in', 'G Rank');
        
//         // $mail-&gt;AddAddress('prashanth@grank.co.in', 'G Rank');
...
?&gt;
</noreply@karolipipes.com></info@vertexcranes.com></body></html>