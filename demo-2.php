...
<p>Well laid out manufacturing plants at HYDERABAD Have all the essential facilities to produce Quality &amp; reliable Equipment.</p>
    ...
    <!---->
    <div class="col-md-5">
        <div id="demo" class="carousel slide csm" data-ride="carousel">
...
<div class="row">
      ...
      <div class="row">
      <div class="qe-01">
      <p>Gantry/ Goliath Cranes are adapted to applications where overhead runways would be very long, costly to Erect and difficult to maintain in alignment. Where the installation is only temporary, a gentry crane can be moved to A new location with less trouble or expenses than an overhead crane and its runway. Also it is comparatively easy And inexpensive to extend the length of the runway and thus increase the working area of the crane. Most gantry Crane Installations are outdoors. The initial cost a gantry crane, which may be double Than that of an overhead crane, must be equated against the additional cost of an overhead runway. “Vertex cranes’ range of gantry cranes can be broadly classified into the following categories.</p>
  ...
  <section id="work" class="portfolio-mf sect-pt4 route">
    ...
    <div class="sr-main1">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            <h3 class="title-a">Infrastructure</h3>
          </div>
        </div>
      </div>
