...
// 	} else if ($json-&gt;success==true) {
 ...
 echo "Captcha Verification Failed";
		...
		$mail = new PHPMailer();		
    	$mail-&gt;From      = 'info@vertexcranes.com';		
    	$mail-&gt;FromName  = "Vertex Cranes";		
    	$mail-&gt;Subject   = $subject;		
    	$mail-&gt;Body      = $message;		
    	$mail-&gt;SetFrom( "info@vertexcranes.com", 'Vertex Cranes');
...
// $mail-&gt;AddBCC('durga@grank.co.in', 'Vertex Cranes');
    //  $mail-&gt;AddBCC('anjali@grank.co.in', 'Vertex Cranes');
// $mail-&gt;AddBCC('kalyanrao@grank.co.in', 'Vertex Cranes');
// $mail-&gt;AddAddress('srinivas@grank.co.in', 'Vertex Cranes');
$mail-&gt;AddAddress('prashanth@grank.co.in', 'Vertex Cranes');
// $mail-&gt;AddAddress('saisreeja@grank.co.in', 'Vertex Cranes');
// $mail-&gt;Addcc('tejaswini@grank.co.in', 'Vertex Cranes');
