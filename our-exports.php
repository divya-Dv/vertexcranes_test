...
<div id="home" class="intro route bg-client">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h1 class="intro-title mb-4">Our Exports</h1> 
...
<div class="container-fluid">
 <div class="row">
            ...
            <!--    <a data-fancybox="gallery" data-src="img/exports/export-inner-one.jpg">-->
            <!--      <img  src="img/exports/export-one.jpg"   alt="Our Exports Image" />-->
            <!--    </a>-->
           ...
           <!--Start single item-->
            ...
            <!--Start single item-->
            <!--<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-3 export-img-width">-->
            <!--    <a data-fancybox="gallery" data-src="img/exports/export-inner-nine.jpg">-->
            <!--      <img src="img/exports/export-nine.jpg"   alt="Our Exports Image" />-->
            <!--    </a>-->
            ...
            <!--Start single item-->
            <!--<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-3 export-img-width">-->
            <!--    <a data-fancybox="gallery" data-src="img/exports/export-inner-ten.jpg">-->
            <!--      <img src="img/exports/export-ten.jpg"   alt="Our Exports Image" />-->
            <!--    </a>-->
            ...
            <!--Start single item-->
            <!--<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-3 export-img-width">-->
            <!--    <a data-fancybox="gallery" data-src="img/exports/export-inner-eleven.jpg">-->
            <!--      <img src="img/exports/export-eleven.jpg"   alt="Our Exports Image" />-->
            <!--    </a>-->
            ...
            <!--Start single item-->
            <!--<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-3 export-img-width">-->
            <!--    <a data-fancybox="gallery" data-src="img/exports/export-inner-fourteen.jpg">-->
            <!--      <img src="img/exports/export-fourteen.jpg"   alt="Our Exports Image" />-->
            <!--    </a>-->
            ...
            <!--    <img class="img_da" src="img/exports/export-eight.jpg">-->
            <!--</div>-->
            <!--End single item-->
