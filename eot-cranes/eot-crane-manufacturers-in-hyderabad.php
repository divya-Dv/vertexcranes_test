    ...
    <div class="intro-content display-table">
      ...
      <div class="table-cell">
        ...
        <div class="container">
          ...
          <h1 class="intro-title mb-4">EOT Crane Manufacturers in Hyderabad</h1>         
...
<div class="container">
 ...
 <div class="row">
<div class="col-md-8">
   <h2 style="font-size:28px;margin:24px;margin-left:0px">EOT Crane Product Description</h2>
   <p>Vertex Cranes Industries is a dominant and reputed EOT Crane Manufacturers in Hyderabad. The capacities of EOT cranes are more than 50 tons and are used to lift and drop heavy materials and it transmits them one place to other places.</p>
   <p>EOT Crane Manufacturers in Hyderabad are listed amongst the best manufacturers for providing superior quality cranes in the relevant market. We deal with 2 types of EOT cranes such as single girder and double girder EOT cranes. Robust designs and manufacturing of cranes by using advance technology. We also deal with loading, unloading and transporting of these products in Hyderabad and all over the country. Our adept professionals are highly qualified and carry the quality test on each part EOT cranes. The smooth working of our EOT Cranes makes the employment simple and less prolonged with no harm to the good’s quality, thus it makes easy to deliver fast and to carry client satisfaction.</p>
   </div>
   <div class="col-md-4">
   <div class="work-box">
                ...
                <div class="col-md-12">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
					            <ul>
                        <li>Robust Design / Construction</li>
                        <li>	High Dimensionally accurate</li>
                        <li>	Compact Structure</li>
                        <li>	Highly superior</li>
